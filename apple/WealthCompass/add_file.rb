...
file_path = 'Sources/Shared/UI/DynamicMasonryLayout.swift'

# Find the group
group = project.main_group.find_subpath('WealthCompass/Sources/Shared/UI', true)
if group.nil?
...
file_ref = group.files.find { |f| f.path == 'DynamicMasonryLayout.swift' }
if file_ref.nil?
