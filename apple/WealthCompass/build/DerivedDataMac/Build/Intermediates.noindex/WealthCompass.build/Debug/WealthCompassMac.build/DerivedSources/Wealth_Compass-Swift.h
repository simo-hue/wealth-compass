...
#ifndef WEALTH_COMPASS_SWIFT_H
#define WEALTH_COMPASS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Wealth_Compass",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14Wealth_Compass14MacAppDelegate")
@interface MacAppDelegate : NSObject <NSApplicationDelegate, UNUserNotificationCenterDelegate>
